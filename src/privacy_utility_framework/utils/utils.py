...
def dynamic_train_test_split(
    df: pd.DataFrame, small_threshold: int = 1000, large_threshold: int = 50000
):
    """
    Split the DataFrame into training and test sets with a dynamic test size \
