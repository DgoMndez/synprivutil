...
class KSCalculator(UtilityMetricCalculator):
    ...
    def evaluate(self):
        """
        Calculates the mean Kolmogorov-Smirnov (KS) similarity score between \
            the original and synthetic datasets, per column.
    ...
    def ks_test_columns(self):
        """
        Perform the Kolmogorov-Smirnov (KS) test on each feature of the original and synthetic \
            datasets.
