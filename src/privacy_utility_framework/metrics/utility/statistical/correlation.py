...
class CorrelationCalculator(UtilityMetricCalculator):
    ...
    def evaluate(self, method=CorrelationMethod.PEARSON):
        """
        Evaluate the similarity between the correlation matrices of the original and synthetic \
            datasets.

        Parameters:
        - method: CorrelationMethod (default: CorrelationMethod.PEARSON); the correlation method \
            to apply.
