...
class BasicStatsCalculator(UtilityMetricCalculator):
    ...
    def _calculate_score(self, all_stats, stat_type):
        """
        Calculate the average absolute difference for a specified statistic type \
            (mean, median, or variance) between the original and synthetic datasets.
        ...
        for key in all_stats:
            for _, stats in all_stats[key].items():
                if stat_type == "mean":
    ...
    def compute_basic_stats(self):
        """
        Compute the mean, median, and variance for each column in the original and \
            synthetic datasets.
    ...
    def evaluate(self):
        ...
        Returns:
        - dict; a dictionary with the average score for each statistic type \
            ('mean', 'median', 'var').
        """
