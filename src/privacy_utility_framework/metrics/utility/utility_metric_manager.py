...
class UtilityMetricManager:
    """
    A manager for handling multiple utility metric calculators, enabling batch addition and \
    ...
    def add_metric(self, metric_instance: UtilityMetricCalculator | list[UtilityMetricCalculator]):
        """
