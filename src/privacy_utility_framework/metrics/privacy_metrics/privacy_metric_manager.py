...
class PrivacyMetricManager:
    """
    A manager for handling multiple privacy metric calculators, \
        enabling batch addition and evaluation of metrics.
    """
    ...
    def add_metric(self, metric_instance: PrivacyMetricCalculator | list[PrivacyMetricCalculator]):
        """
    ...
    def evaluate_all(self) -> dict[str, float]:
        ...
        -------
        Dict[str, float]
            A dictionary where keys are metric names concatenated with the dataset names \
                and values are the evaluated metric scores.
        """
        results = {}
