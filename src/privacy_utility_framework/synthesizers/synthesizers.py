"""Backward-compatible synthesizer facade with optional SDV-backed models."""
...
from .core import BaseModel, GaussianMixtureModel, RandomModel  # noqa: F401

if TYPE_CHECKING:
    from .sdv import CopulaGANModel, CTGANModel, GaussianCopulaModel, TVAEModel  # noqa: F401
...
def __getattr__(name: str):
    if name in _SDV_EXPORTS:
        try:
            module = import_module(".sdv", __package__)
